...
Copy `get_cli_args.py` into your playbook repo's `plugins/action/` directory:

```bash
cp scratchpad/ansible/plugins/action/get_cli_args.py \
   your-repo/plugins/action/get_cli_args.py
```

Then point `ansible.cfg` at it:
